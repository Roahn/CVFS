...
void man(char *name)
{
    ...
    {
        printf("Describe : Used to create new regular file\n");
        printf("Usage :create File_name Permission\n");
    }
    else if (strcmp(name, "read") == 0)
    {
        printf("Description : Used to read dtaa from regular file \n");
    ...
    {
        printf("Description: Used to change file offset file\n");
    ...
    else if (strcmp(name, "rm File_name") == 0)
    {
        printf("Description: Used to remove data from file\n");
        printf("Usage :truncate File_name \n");
    }
...
void DisplayHelp()
{
    ...
    printf("write :To write into file\n");
    ...
    while (1)
    {
        ...
        else if (count == 2)
        {
            ...
            else if (strcmp(command[0], "rm") == 0)
            {
                ...
                if (ret == -1)
                {
                    printf("ERROR : Therer is no such a file\n");
                }
                continue;
            }
        ...
        else if (count == 3)
        {
            if (strcmp(command[0], "create") == 0)
            {
                ...
                if (ret >= 0)
                {
                    printf("File Successfully created with the file descriptor : %d\n", ret);
                }
                if (ret == -1)
                {
                    printf("ERROR : Incorrect parameters \n");
            ...
            else if (strcmp(command[0], "open") == 0)
            {
                ...
                if (ret >= 0)
                {
                    printf("File Successfully opened with the file descriptor : %d\n", ret);
                }
                if (ret == -1)
                {
                    printf("ERROR : Incorrect parameters \n");
            ...
            else if (strcmp(command[0], "read") == 0)
            {
                ...
                if (ptr == NULL)
                {
                    printf(" ERROR : Memory allocatin failure \n");
                    continue;
                }
